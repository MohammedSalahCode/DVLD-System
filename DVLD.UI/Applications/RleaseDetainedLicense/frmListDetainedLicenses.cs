    ...
    public partial class frmListDetainedLicenses: Form
    {
        ...
        private void frmListDetainedLicenses_Load(object sender, EventArgs e)
        {
            ...
            if (dgvDetainedLicenses.Rows.Count > 0)
            {
                ...
                dgvDetainedLicenses.Columns[0].Width = 50;

                dgvDetainedLicenses.Columns[1].HeaderText = "L.ID";
                dgvDetainedLicenses.Columns[1].Width = 50;
                ...
                dgvDetainedLicenses.Columns[8].Width = 60;
        ...
        private void textFilterValue_TextChanged(object sender, EventArgs e)
        {
            ...
            if (FilterColumn == "DetainID" || FilterColumn == "ReleaseApplicationID")
                ...
                _dtDetainedLicenses.DefaultView.RowFilter = string.Format("[{0}] = {1}", FilterColumn, textFilterValue.Text.Trim());
            else
                _dtDetainedLicenses.DefaultView.RowFilter = string.Format("[{0}] LIKE '{1}%'", FilterColumn, textFilterValue.Text.Trim());
        ...
        private void tnReleaseDetainedLicense_Click(object sender, EventArgs e)
        {
